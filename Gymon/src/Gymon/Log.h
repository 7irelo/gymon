...
// spdlog includes <Windows.h> indirectly on some sinks; silence the min/max macros.
...
#define GY_CORE_FATAL(...)  ::Gymon::Log::GetCoreLogger()->critical(__VA_ARGS__)
...
#define GY_FATAL(...)		::Gymon::Log::GetClientLogger()->critical(__VA_ARGS__)
