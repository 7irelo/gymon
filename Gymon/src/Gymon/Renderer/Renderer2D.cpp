...
namespace Gymon {
	...
	static const std::string s_TextureShaderSrc_Vertex = R"(
#version 410 core
...
void main()
{
	...
	static const std::string s_TextureShaderSrc_Fragment = R"(
#version 410 core
...
void main()
{
	...
	void Renderer2D::Init()
	{
		...
		s_Data.TextureShader = Shader::Create("Renderer2D_Texture", s_TextureShaderSrc_Vertex, s_TextureShaderSrc_Fragment);
	...
	{
		s_Data.TextureShader->Bind();
		std::static_pointer_cast<OpenGLShader>(s_Data.TextureShader)->UploadUniformMat4("u_ViewProjection", camera.GetViewProjectionMatrix());
